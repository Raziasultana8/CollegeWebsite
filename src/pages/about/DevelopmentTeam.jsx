  ...
  return (
    <div className='w-full h-screen' style={imageStyle}>
      ...
      <div className="flex flex-wrap w-full justify-center gap-3 py-9">
        <ProfileCard imgSrc="/images/Mahmood.jpg" title="Mahmood Hassan" skill="Supervisor" />
        <ProfileCard imgSrc="/images/danish1.jpg" title="Danish Nazir" skill="MERN Developer"  />

        <ProfileCard imgSrc="/images/demi.png" title="Hamza" skill="MERN Developer"/>
      </div>
